...
class _ThemeSelectionScreenState extends State<ThemeSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isSystemLight = MediaQuery.of(context).platformBrightness == Brightness.light;
    final String defaultBgImage = isSystemLight ? 'assets/buttons/bg_accent.png' : 'assets/buttons/bg_neon.png';
    final Color defaultTextColor = isSystemLight ? Colors.black : Colors.white;
    final String defaultIconPath = isSystemLight ? 'assets/icons/ico_theme_default_accent.png' : 'assets/icons/ico_theme_default_neon.png';
                  ...
                  Expanded(
                    child: Center(
                      child: Image.asset(
                        ...
                        fit: BoxFit.contain, // This guarantees the aspect ratio remains perfectly intact
                        errorBuilder: (context, error, stackTrace) => const Icon(
                          Icons.broken_image,
                          color: Colors.white,
                          size: 64,
        ...
        child: AspectRatio(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isSelected 
                    ? const Color(0xFF4A4AFF) // Adjust to match the blue outline in the design
                    : Colors.transparent,
                width: 2.5,
              ),
              image: DecorationImage(
                ...
                onError: (exception, stackTrace) => debugPrint('Missing asset: $bgImagePath'),
              ),
